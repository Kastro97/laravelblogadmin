...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">KastroBlog</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          @else
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{route("home")}}">Perfil</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{route("posts.index")}}">Posts</a>
            </li>
            @if(Auth::user()->admin===1)
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="{{route("admin")}}">Administrar</a>
              </li>
            @endif
          @endguest
        </ul>
  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase">KastroBlog</h1>
  ...
  <footer class="bg-black small text-center text-white-50">
    <div class="container">
      Copyright &copy; KastroBlog 2019
    </div>
  </footer>
